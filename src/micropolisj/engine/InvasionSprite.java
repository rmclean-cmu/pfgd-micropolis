...
/**
 * Implements an Alien Invasion (one of the Micropolis disasters).
 */
public class InvasionSprite extends Sprite
{
	...
	public InvasionSprite(Micropolis engine, int xpos, int ypos)
	{
		super(engine, SpriteKind.INV);
		this.x = xpos * 16 + 8;
		this.y = ypos * 16 + 8;
		this.width = 48;
		this.height = 48;
